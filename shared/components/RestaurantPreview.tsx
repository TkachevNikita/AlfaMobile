...
const RestaurantPreview: React.FC<RestaurantPreviewProps> = ({restaurant}) => {
    ...
    return (
        <Pressable onPress={() => navigation.navigate("Restaurant" as never)}>
        <View>
            <Image
                source={{uri: restaurant.image}}
                style={{ width: '100%', height: 150, borderTopRightRadius: 32, borderTopLeftRadius: 32 }}
            />
            <View style={styles.card__description}>
                ...
                <View style={styles.card__rating}>
                    <Svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                        <Path
                            ...
                            fill={restaurant.rating > 4 ? 'green' : 'orange'}/>
                    </Svg>
                    <Text>
                        {restaurant.rating}
                    </Text>
